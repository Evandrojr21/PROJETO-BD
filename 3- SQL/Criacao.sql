...
CREATE TABLE Físico (
    ...
    CONSTRAINT FK_FISICO_EDICAO FOREIGN KEY (data_hora, CNPJ) REFERENCES Edição(data_hora, CNPJ));
...
CREATE TABLE Digital (
    ...
    CONSTRAINT FK_DIGITAL_EDICAO FOREIGN KEY (data_hora, CNPJ) REFERENCES Edição(data_hora, CNPJ));
...
CREATE TABLE Possui (
    ...
    CONSTRAINT FK_POSSUI_EDICAO FOREIGN KEY (data_hora, CNPJ) REFERENCES Edição(data_hora, CNPJ),
...
CREATE TABLE Escreve (
    ...
    CONSTRAINT FK_ESCREVE_CPF FOREIGN KEY (Id) REFERENCES EDITOR(Id));
...
CREATE TABLE Coordena (
    CPF VARCHAR2(11),
    COD INT,
    CONSTRAINT PK_COORDENA PRIMARY KEY (CPF, COD)
...
CREATE TABLE Participa (
    CPF VARCHAR2(11) REFERENCES Coordena(CPF),
    CPF_colab VARCHAR2(11) REFERENCES Colaborador(CPF),
    CONSTRAINT PK_PARTICIPA PRIMARY KEY (CPF, CPF_colab)
    CONSTRAINT FK_PARTICIPA_CPF_COLA FOREIGN KEY (COD) REFERENCES COLABORADOR(CPF),
    CONSTRAINT FK_PARTICIPA_CPF_CORDENA FOREIGN KEY (CPF) REFERENCES COORDENA(CPF));